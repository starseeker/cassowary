...
class ClAbstractVariable {
  ...
  public:
    ...
    virtual bool IsFDVariable() const { return false; }
    ...
    virtual bool IsPivotable() const {
        throw ExCLTooDifficultSpecial(
            "Variable not usable inside SimplexSolver");
        return false;
    }
    ...
    friend bool operator<(const ClAbstractVariable &cl1,
                          const ClAbstractVariable &cl2) {
        return &cl1 < &cl2;
    }
