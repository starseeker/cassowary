...
class ClTimedSimplexSolver : public ClSimplexSolver {
  protected:
    typedef ClSimplexSolver super;

  public:
    // Constructor
    ClTimedSimplexSolver()
        : ClSimplexSolver(), _cAdd(0), _cRemove(0), _cBeginEdit(0),
          _cEndEdit(0), _cResolve(0) {}
    ...
    Timer &GetAddTimer() { return _addTimer; }

    Timer &GetRemoveTimer() { return _removeTimer; }

    Timer &GetBeginEditTimer() { return _beginEditTimer; }

    Timer &GetEndEditTimer() { return _endEditTimer; }

    Timer &GetResolveTimer() { return _resolveTimer; }
